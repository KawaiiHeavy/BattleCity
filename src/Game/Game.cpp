...
bool Game::init() {
    ...
    auto pTextureAtlas = ResourceManager::loadTextureAtlas("DefaultTextureAtlas", "res/textures/map16x16.png", std::move(subTexturesNames), 16, 16);
    ...
    pAnimatedSprite->insertState("eagleState", std::move(waterState));
    ...
    tankTopState.emplace_back(std::make_pair<std::string, uint64_t>("tankTop1", 5 * 10e8));
    tankTopState.emplace_back(std::make_pair<std::string, uint64_t>("tankTop2", 5 * 10e8));

    std::vector<std::pair<std::string, uint64_t>> tankBottomState;
    tankBottomState.emplace_back(std::make_pair<std::string, uint64_t>("tankBottom1", 5 * 10e8));
    tankBottomState.emplace_back(std::make_pair<std::string, uint64_t>("tankBottom2", 5 * 10e8));

    std::vector<std::pair<std::string, uint64_t>> tankRightState;
    tankRightState.emplace_back(std::make_pair<std::string, uint64_t>("tankRight1", 5 * 10e8));
    tankRightState.emplace_back(std::make_pair<std::string, uint64_t>("tankRight2", 5 * 10e8));

    std::vector<std::pair<std::string, uint64_t>> tankLeftState;
    tankLeftState.emplace_back(std::make_pair<std::string, uint64_t>("tankLeft1", 5 * 10e8));
    tankLeftState.emplace_back(std::make_pair<std::string, uint64_t>("tankLeft2", 5 * 10e8));
